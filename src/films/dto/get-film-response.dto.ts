...
import { PersonFilmWithPersonResponseDto } from 'src/persons/dto/person-film-response.dto';
...
export class GetFilmResponseDto extends FilmResponseDto {
  ...
  @ApiProperty({ type: [PersonFilmWithPersonResponseDto] })
  personFilms: PersonFilmWithPersonResponseDto[];
