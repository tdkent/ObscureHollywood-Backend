...
import { PersonFilmWithFilmResponseDto } from 'src/persons/dto/person-film-response.dto';

export class GetPersonResponseDto extends PersonResponseDto {
  @ApiProperty({ type: ArticleResponseDto })
  article: ArticleResponseDto;

  @ApiProperty({ type: [PersonFilmWithFilmResponseDto] })
  personFilms: PersonFilmWithFilmResponseDto[];
}
